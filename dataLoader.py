...
#             return x_train, y_train, x_test, y_test
        ...
        if self.max_min_scale:
            self.x_train,_ , _ = self.MinMaxScaler(self.x_train)
            self.x_test,_ , _ = self.MinMaxScaler(self.x_test)
